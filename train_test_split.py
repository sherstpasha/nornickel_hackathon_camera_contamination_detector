...
def split_data(input_dir, output_dir, test_size=0.33):
    ...
    print(
        f"Разделение данных завершено. Обучающие данные: {len(train_files)}, тестовые данные: {len(test_files)}"
    )


# Указание путей
orig_img_path = r"C:\Users\pasha\OneDrive\Рабочий стол\datadata\orig_data\open_img"
orig_msk_path = r"C:\Users\pasha\OneDrive\Рабочий стол\datadata\orig_data\open_msk"

# Новые папки для разделенных данных
output_img_path = (
    r"C:\Users\pasha\OneDrive\Рабочий стол\datadata\split_orig_data\open_img"
)
output_msk_path = (
    r"C:\Users\pasha\OneDrive\Рабочий стол\datadata\split_orig_data\open_msk"
)
